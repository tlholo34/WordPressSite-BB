...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'       => niveau_theme()->getPluginsManager()->getPluginState( niveau_get_builder_plugin_slug() ),
			'install_url'  => niveau_theme()->getPluginsManager()->getInstallLink( niveau_get_builder_plugin_slug() ),
			'activate_url' => niveau_theme()->getPluginsManager()->getActivationLink( niveau_get_builder_plugin_slug() ),
			'slug'         => niveau_get_builder_plugin_slug(),
			'messages'     => array(
		...
		<div class="content-holder">
			<div class="front-page-preview">
				...
				<div class="kubio-front-page-preview-image-scroller">
					<img src="<?php echo esc_url( niveau_theme()->getFrontPagePreview() ); ?>"/>
				</div>
			</div>

			<div class="messages-area">
				<div class="title-holder">
					<h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', niveau_theme()->getName() ); ?></h1>
				</div>
				<div class="action-buttons">
					<button class="button button-primary button-hero start-with-predefined-design-button">
						<?php Translations::escHtmlE( 'install_homepage', niveau_theme()->getName() ); ?>
					</button>
				</div>
