...
= How can I customize Niveau? =

    To customize the Niveau theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

Niveau WordPress theme, Copyright (C) 2021 ExtendThemes
Niveau WordPress theme is licensed under the GPL3.
...
- Images
  ...
  These assets are distributed under the CC0 License:
        ...
        Source: https://stocksnap.io/photo/moon-dark-PQXYMRLH8S
...
- Google Fonts:
      ...
      Licensed under  Apache License, Version 2.0 (https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)
