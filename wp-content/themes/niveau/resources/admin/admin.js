...
(function ($) {
  ...
  if (!window.niveau_admin) {
    return;
  }

  var _window$niveau_admin = window.niveau_admin,
      builderStatusData = _window$niveau_admin.builderStatusData,
      getStartedData = _window$niveau_admin.getStartedData;
